      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            />
            <span className="text-[#e6d8c3] font-bold text-sm md:text-base">
              YEKA Producciones
            </span>
          </div>

          {/* Contact Info - inline */}
          <div className="flex flex-wrap items-center justify-center gap-x-4 md:gap-x-6 gap-y-1 text-[#e6d8c3] text-xs md:text-sm">
          ...
          <div className="flex items-center space-x-4 md:space-x-6">
            <a
              href="https://www.instagram.com/yekaproducciones"
              target="_blank"
        ...
        <div className="border-t border-[#5d866c] mt-3 md:mt-4 pt-2 md:pt-3 text-center">
